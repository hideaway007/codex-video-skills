...
| `d2-editorial-grid` | **本项目默认主题**。纸面档案编辑风。暖白网格纸面 + 深棕墨色 + 锈红强调。Noto Serif SC 中文大标题 + 等宽 metadata。文件卡、章节索引、状态标记气质，适合知识管理、AI coding、Agent 工作流和项目复盘。 |
