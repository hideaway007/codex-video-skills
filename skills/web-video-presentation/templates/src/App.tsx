...
import { useMasterAudioTimeline } from "./hooks/useMasterAudioTimeline";
...
export default function App() {
  ...
  const recordMode = readFlagFromURL("record");
  const masterAudio = useMasterAudioTimeline({
    mode,
    autoStarted,
    currentGlobalIndex: stepper.globalIndex,
    onCue: stepper.jumpToGlobal,
  });
  const segmentedPlaybackMode =
    mode === "auto" && masterAudio.status !== "unavailable" ? "manual" : mode;
  ...
  const audioSrc =
    segmentedPlaybackMode === "manual" || stepText === ""
      ? null
  ...
  return (
    <>
      <Stage onAdvance={stepper.next} recordMode={recordMode}>
