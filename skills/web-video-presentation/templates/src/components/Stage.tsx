 ...
 */
export function Stage({ onAdvance, recordMode = false, children }: Props) {
  const scale = useStageScale(1920, 1080, 80, 100, recordMode);
  ...
  return (
    <div className={recordMode ? "app-shell app-shell-record" : "app-shell"}>
